    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto bg-white">
        <div className="text-center mb-20 relative">
          <div className="absolute top-0 right-0 font-['Josefin_Sans'] text-xs uppercase tracking-[0.5em] text-[#5E7361] -mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="group text-center flex flex-col items-center">
            ...
            <p className="font-['Josefin_Sans'] text-[#5E7361] italic text-lg leading-tight">
          ...
          <div className="group text-right flex flex-col items-end">
            ...
            <h4 className="font-['Diner_Fatt'] text-[#2B4233] text-4xl mb-2">Cajas de Felicidad</h4>
            <p className="font-['Josefin_Sans'] text-[#5E7361] text-xs uppercase tracking-widest">PERFECTAS PARA REGALAR MOMENTOS</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#2B4233] text-[#F6CDD7] py-20 px-6 text-center">
        <div className="mb-10">
          <p className="font-['Diner_Fatt'] text-5xl tracking-[0.2em] mb-2 text-[#F6CDD7]">TYTA Pastelería</p>
        ...
        <div className="space-y-2 font-['Josefin_Sans'] text-sm tracking-wide">
          ...
          <a href="https://wa.me/5491130302451" target="_blank" className="pt-4 text-[#EDB2D1] font-['Diner_Fatt'] font-bold block hover:brightness-110">@tytapatisserie</a>
        </div>
