...
export default function TiendaPage() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      const whatsappNumber = "5491132125647"; 
  ...
  return (
    <div className="flex flex-col h-screen bg-[#FDFBF7] text-[#2B4233] font-josefin overflow-hidden relative">
      ...
      <div className="fixed bottom-[8vh] right-6 md:right-10 z-[60] flex flex-col gap-3 items-end">
        <a href="https://api.whatsapp.com/send?phone=5491132125647" target="_blank" className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-all">
